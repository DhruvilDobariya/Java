...
public class Constructure {
	public static void main(String[] args) {
		...
		System.out.println(obj5.length);  // When we defind constructure then, we initializ by defulte int value.
		System.out.println(obj5.backgroundcolor);  // When we defind constructure then, we initializ by defulte int value.
	}
}